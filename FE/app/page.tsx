          ...
          <main className="flex-1 container mx-auto px-3 sm:px-2 sm:px-4 py-2 sm:py-1 sm:py-2 md:overflow-hidden">
            <div className="min-h-0 md:h-full flex flex-col">
              <div className="text-center mb-3 sm:mb-1 sm:mb-2 md:mb-3 flex-shrink-0">
                <h1 className="text-2xl sm:text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold mb-2 sm:mb-1 bg-gradient-to-r from-yellow-400 to-yellow-600 bg-clip-text text-transparent">FLIPEN</h1>
                <p className="text-sm sm:text-xs md:text-sm text-muted-foreground mb-2 sm:mb-1">Where Fortune Favors the Bold</p>
                <p className="text-sm sm:text-xs text-gold font-semibold italic">Optimized for Celo & MiniPay</p>
              </div>
